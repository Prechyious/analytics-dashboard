...
const ThemeToggle = () => {
    ...
    return (
        <div
            className="h-[5.25rem] w-[2.875rem] flex flex-col bg-white items-center justify-between rounded-[6.25rem] relative gap-4 p-2 dark:bg-transparent dark:border dark:border-gray-500 cursor-pointer"
